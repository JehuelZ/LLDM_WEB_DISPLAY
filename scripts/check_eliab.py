...
def main():
    print("Checking Eliab Aguilar profile...")
    import urllib.parse
    params = urllib.parse.quote("name=eq.E.E. Eliab Aguilar&select=id,auth_user_id,role,roles,email", safe="=&")
    eliab = make_request("GET", f"profiles?{params}")
    print(json.dumps(eliab, indent=2))
