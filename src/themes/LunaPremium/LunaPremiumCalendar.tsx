                ...
                <div className="grid grid-cols-7 mb-4">
                    {['dom', 'lun', 'mar', 'mié', 'jue', 'vie', 'sáb'].map((d, i) => (
                        <div key={d} className="relative text-center">
                            ...
                            {/* Tiny vertical divider marker (Enhanced Electric Flare) */}
                            {i < 6 && (
                                <div className="absolute top-1/2 -right-[1px] -translate-y-1/2 w-[1px] h-3 bg-gradient-to-b from-transparent via-amber-500/80 to-transparent shadow-[0_0_6px_rgba(245,158,11,0.6)]" />
                            )}
                        </div>
                    ))}
                </div>
                ...
                >
                    ...
                    {days.map((date, idx) => {
                        ...
                        return (
                            ...
                            >
                                {/* Vertical Column Divider (Electric Flare - Enhanced for 4K visibility) */}
                                {!isLastCol && (
                                    <div className="absolute inset-y-0 -right-[1px] w-[1px] bg-gradient-to-b from-transparent via-amber-500/80 to-transparent shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
                                )}
