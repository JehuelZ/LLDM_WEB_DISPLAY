...
export function PublicSchedule() {
  ...
  const services = [
    {
      time: settings.publicHomeService1Time || '5:00 AM',
      title: settings.publicHomeService1Title || 'Oración Matutina',
      desc: settings.publicHomeService1Desc || 'Primera oración del día para consagrar la jornada en gratitud y comunión con Dios.',
      days: settings.publicHomeService1Days || 'Lunes a Domingo',
      badge: 'Diario',
      icon: Sun,
      color: 'from-amber-500/20 to-orange-500/10 text-amber-400 border-amber-500/30',
    },
    {
      time: settings.publicHomeService2Time || '9:00 AM',
      title: settings.publicHomeService2Title || 'Consagración y Estudio Bíblico',
      desc: settings.publicHomeService2Desc || 'Oración de consagración y estudio de las doctrinas cristianas fundamentales.',
      days: settings.publicHomeService2Days || 'Lunes a Domingo',
      badge: 'Mañana',
      icon: BookOpen,
      color: 'from-orange-500/20 to-amber-500/10 text-orange-400 border-orange-500/30',
    },
    {
      time: settings.publicHomeService3Time || '6:00 PM',
      title: settings.publicHomeService3Title || 'Oración de la Tarde',
      desc: settings.publicHomeService3Desc || 'Servicio de alabanza, oración y predicación de la palabra de Dios.',
      days: settings.publicHomeService3Days || 'Lunes a Domingo (6:00 PM / 7:00 PM)',
      badge: 'Principal',
      icon: Clock,
      color: 'from-purple-500/20 to-indigo-500/10 text-purple-400 border-purple-500/30',
    },
    {
      time: settings.publicHomeService4Time || '10:00 AM',
      title: settings.publicHomeService4Title || 'Escuela Dominical',
      desc: settings.publicHomeService4Desc || 'Clases bíblicas para niños, jóvenes y adultos. Formación en la fe y doctrina cristiana.',
      days: settings.publicHomeService4Days || 'Domingos',
      badge: 'Dominical',
      icon: Sparkles,
