  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-16">
      ...
      <motion.div
        initial={{ opacity: 0, y: 16 }}
        animate={{ opacity: 1, y: 0 }}
        className="bg-white/[0.03] border border-pink-500/30 rounded-3xl p-6 backdrop-blur-xl space-y-6 shadow-xl shadow-pink-500/5 ring-1 ring-pink-500/20"
      >
        <div className="flex items-center gap-3 pb-4 border-b border-white/5">
          ...
          <div>
            <h3 className="text-base font-extrabold text-white flex items-center gap-2">
              <span>Tipografía (Google Fonts) & Diseño de Botones</span>
              <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-pink-500/20 text-pink-300 border border-pink-500/40">Nuevo</span>
            </h3>
            <p className="text-xs text-white/40">Personaliza las fuentes tipográficas de Google Fonts para títulos/subtítulos y cambia el color y estilo de los botones.</p>
          </div>
        </div>
