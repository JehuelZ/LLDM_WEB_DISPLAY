...
import { MonitorMessages } from '@/components/monitor/MonitorMessages';
import { MonitorReport } from '@/components/monitor/MonitorReport';
    ...
    return (
        <div className="min-h-screen bg-background text-foreground transition-colors duration-500">
            ...
            <main className="container mx-auto p-4 md:p-8 space-y-8 pb-32 md:pb-8 animate-in fade-in duration-700">
                ...
                {viewMode === 'reportes' && <MonitorReport />}
                {viewMode === 'mensajes' && <MonitorMessages />}
