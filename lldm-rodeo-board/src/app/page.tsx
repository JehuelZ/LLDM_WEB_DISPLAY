...
import { Calendar, Clock, BookOpen, User, Bell, ClipboardCheck, Camera, Mail, Phone, Save, Edit2, X, Flame, CheckCircle2, TrendingUp, Star } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {[
                      { id: 'Administrador', icon: User, label: 'Administrador' },
