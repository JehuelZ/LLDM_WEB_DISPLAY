        ...
        <div className="flex flex-col items-center gap-2 group transition-transform duration-300 hover:scale-105">
            <div className="relative" style={{ width: size, height: size }}>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center -rotate-0">
                    ...
                    <span className="text-[10px] uppercase font-bold text-slate-500 tracking-tighter">{value}/{total}</span>
                </div>
            </div>
...
const INITIAL_MEMBERS: Member[] = [
    ...
    {
        id: '4', name: 'Esther Lopez', role: 'Miembro', gender: 'Hermana', member_group: 'Solteras', email: 'esther.l@gmail.com', phone: '444-555-6666', status: 'Activo', lastActive: 'Hace 2 horas',
        ...
        <div className="p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground font-light">Administre y organice la iglesia de LLDM RODEO</p>
                </div>
                <Button
            ...
            <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-4">
                <Card className="glass-card bg-primary/5 border-primary/20 p-6 flex items-center justify-between group overflow-hidden relative">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black text-white italic">{globalAttendance}%</h3>
                ...
                <Card className="glass-card bg-secondary/5 border-secondary/20 p-6 flex items-center justify-between group overflow-hidden relative">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black text-white italic">{globalParticipation}%</h3>
                        <p className="text-[10px] text-slate-500 mt-2 flex items-center gap-1 font-bold lowercase">
                ...
                <Card className="glass-card bg-accent/5 border-accent/20 p-6 flex items-center justify-between group overflow-hidden relative">
                    <div className="relative z-10">
                        ...
                        <h3 className="text-3xl font-black text-white italic">+12</h3>
                        <p className="text-[10px] text-slate-500 mt-2 flex items-center gap-1 font-bold">
                ...
                <Card className="glass-card bg-emerald-500/5 border-emerald-500/20 p-6 flex items-center justify-between group overflow-hidden relative">
                    <div className="relative z-10">
                        <p className="text-xs font-bold uppercase tracking-widest text-emerald-400 mb-1">Puntualidad</p>
                        <h3 className="text-3xl font-black text-white italic">94%</h3>
                        <p className="text-[10px] text-slate-500 mt-2 flex items-center gap-1 font-bold uppercase">
                            PROMEDIO GENERAL
                        </p>
                    </div>
                    <div className="w-20 h-20 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                        <div className="relative w-full md:w-96">
                            ...
                            <Input
                                ...
                                className="pl-10 bg-foreground/5 border-border/40 text-white focus:ring-primary/50"
                                value={searchTerm}
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-border/20">
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500 w-10"></th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Miembro</th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Rol</th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Estado</th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Participación</th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Última Actividad</th>
                                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-widest text-slate-500">Acciones</th>
                                </tr>
                            </thead>
                                    ...
                                    <Fragment key={member.id}>
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                {expandedMember === member.id ? <ChevronUp className="h-4 w-4 text-primary" /> : <ChevronDown className="h-4 w-4 text-slate-500" />}
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex gap-2 items-center">
                                                            <span className="text-[10px] text-slate-500 uppercase font-black">{member.gender}</span>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className={cn(
                                                        "text-xs font-medium",
                                                        member.status === 'Activo' ? "text-emerald-400" : "text-slate-500"
                                                    )}>
                                                        {member.status}
                                                    </span>
                                                </div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs font-bold text-white">{(member.stats.attendance.attended / member.stats.attendance.total * 100).toFixed(0)}%</span>
                                                </div>
                                            </td>
                                                        ...
                                                        <div className="col-span-1 border-r border-border/20 pr-8 space-y-6">
                                                            ...
                                                            <div className="space-y-4">
                                                                ...
                                                                <div className="space-y-2">
                                                                    <div className="flex items-center gap-2 text-xs text-slate-400"><Mail className="h-3 w-3" /> {member.email}</div>
                                                                    <div className="flex items-center gap-2 text-xs text-slate-400"><Phone className="h-3 w-3" /> {member.phone}</div>
                                                                    ...
                                                                    <div className="flex items-center gap-2 text-xs text-slate-400 uppercase font-bold text-[10px] tracking-widest mt-4">Puesto: {member.role}</div>
                                                                </div>
                                                                <Button
                                                                    variant="outline"
                                                                    size="sm"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <option value="Solteras">Solteras</option>
