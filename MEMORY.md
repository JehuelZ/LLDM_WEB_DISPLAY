...
- **Servicios Especiales & Galería de Medios (Julio 21, 2026):**
  ...
  - Se creó un modal de **Galería de Medios (`MediaGalleryModal`) estilo WordPress** con:
    ...
    - **Botón "Elegir de Galería" en Formularios de Perfiles**: al crear o editar cualquier perfil (Miembros, Ministro Responsable, Supervisor o Mi Perfil Admin), el administrador puede presionar **"Elegir de Galería"** para vincular al instante una foto previamente subida en lugar de volver a subirla.
