...
CREATE TABLE schedule (
  ...
  five_am_time TEXT,
  five_am_end_time TEXT,
  five_am_custom_label TEXT,
  five_am_language TEXT DEFAULT 'es',

  -- 9 AM
  nine_am_consecration_leader_id UUID REFERENCES profiles(id),
  nine_am_doctrine_leader_id UUID REFERENCES profiles(id),
  nine_am_time TEXT,
  nine_am_end_time TEXT,
  nine_am_custom_label TEXT,
  nine_am_language TEXT DEFAULT 'es',

  -- 12 PM
  noon_leader_id UUID REFERENCES profiles(id),
  noon_time TEXT,
  noon_end_time TEXT,
  noon_custom_label TEXT,

  -- Evening
  evening_service_type TEXT,
  evening_service_time TEXT DEFAULT '6:30 PM',
  evening_service_end_time TEXT,
  evening_service_language TEXT DEFAULT 'es',
  evening_leader_ids UUID[] DEFAULT '{}',
  evening_custom_label TEXT,
